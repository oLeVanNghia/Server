...
public class ConnectToServer implements Runnable {
	...
	private ArrayList<String[]> infors;
	
	BufferedReader reader = null;
	PrintWriter writer = null;
	
	public ConnectToServer(int inport, String inservername,String request) {
		this.port = inport;
	...
	public ConnectToServer(int inport, String inservername, String data,String request) {
		this.port = inport;
		this.servername = inservername;
		this.data = data;
		this.proto = request;
...
//		ConnectToServer connect = new ConnectToServer(6543, "127.0.0.1", "post");
...
//		thread.start();
		...
		String data = "forever";
		ConnectToServer connect = new ConnectToServer(6543, "127.0.0.1", "get");
		connect.setData(data);
		Thread thread = new Thread(connect);
		thread.start();
